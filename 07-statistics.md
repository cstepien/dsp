...
>> 5/11. P(boys|identical) = 1/2; P(Identical) = 1/300; P(boys|fraternal twins) = 1/4; P(fraternal) = 1/125. If we plug these values into Bayes' Theorem we get 5/11.
...
>> Bayesian statistics use prior beliefs to inform a probability distribution, while in frequentist statistics underlying parameters are fixed.  I really like the discussion of the two in [this link.](https://stats.stackexchange.com/questions/22/bayesian-and-frequentist-reasoning-in-plain-english)
